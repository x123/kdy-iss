...
!!! Warning
    If there is *any* doubt about a swift recovery, the skipper will use the VHF or
    delegate to the crew to call on VHF 16 for assistance. The Maritime SAR
    Convention defines the distress phase as *"a situation wherein there is
    ...
    __A man overboard is almost *always* a distress situation.__
...
#### Jib
- Ensure the jib sheets are run inside the shrouds.

#### Genoa
- Ensure the genoa sheets are run outside the shrouds.
